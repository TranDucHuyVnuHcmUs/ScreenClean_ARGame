...
#pragma warning restore IDE0065
    ...
    public sealed class GameConnectionListAnnotation : ListAnnotation<ConnectionAnnotation>
    {
        ...
        public void Fill(IList<(int, int)> connections, GamePointListAnnotation points)
        {
